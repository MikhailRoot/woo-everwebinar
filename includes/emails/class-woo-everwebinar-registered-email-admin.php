...
/**
 * Class Woo_EverWebinar_Registered_Email_Admin
 *
 * @extends \WC_Email
 */
class Woo_EverWebinar_Registered_Email_Admin extends WYSIWYG_Email {

	/**
	 * Woo_EverWebinar_Registered_Email_Admin constructor.
	 */
	public function __construct() {
		 ...
		 */
		$this->id = 'woo_everwebinar__registered_to_webinar_admin';

		$this->customer_email = false;

		$this->title = __( 'Registered to Webinar', 'woo-everwebinar' );

		$this->description = __( 'Email which is sent to administrator with client access links to webinar after registration', 'woo-everwebinar' );

		$this->template_base = PluginDirPath . '/templates/';

		$this->template_html = 'emails/everwebinar-registered-to-webinar-admin.php';

		$this->template_plain = 'emails/plain/everwebinar-registered-to-webinar-admin.php';
	...
	public function get_default_subject() {
		return __( '{email} has registered to webinar {webinar_name}', 'woo-everwebinar' );
	}
	...
	private function get_default_main_content_html() {
		ob_start();
		include PluginDirPath . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'default-email-contents' . DIRECTORY_SEPARATOR . 'main-admin.php';
		return ob_get_clean();
	}
	...
	private function get_default_main_content_plain() {
		ob_start();
		include PluginDirPath . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'default-email-contents' . DIRECTORY_SEPARATOR . 'main-admin.plain.php';
		return ob_get_clean();
	}
